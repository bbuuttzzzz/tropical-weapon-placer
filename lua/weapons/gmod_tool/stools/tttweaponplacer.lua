...
TOOL.Name = "Tropical TTT Weapon Placer"
TOOL.Command = nil
TOOL.ConfigName = ""
...
local weps = {
    ...
    ttt_random_weapon_small = {name="Random sidearm", snd="ttt_random_ammo"},
    ttt_random_ammo = {name="Random ammo", snd=nil},
    ttt_random_grenade = {name="Random Grenade"},
    ttt_random_rare = {name="Rare Item"},
...
local mdls = {
    ...
    ttt_random_weapon_small = "models/weapons/w_alyx_gun.mdl",
    ttt_random_ammo = "models/Items/battery.mdl",
    ttt_random_grenade = "models/items/grenadeammo.mdl",
    ttt_random_rare = "models/items/item_item_crate.mdl",
...
local colors = {
    ...
    ttt_random_weapon_small = Color(255, 255, 0),
    ttt_random_ammo = Color(0, 255, 0),
    ttt_random_grenade = Color(255, 0, 0),
    ttt_random_rare = Color(0, 0, 255),
...
function TOOL.BuildCPanel(panel) -- note that this is not a method, REAL NICE
    ...
    panel:AddControl("Button", {Label="Convert Everything to Random", Command = "tttweaponplacer_replacerandom", Text="Convert"})
...
local enttypes = {
    ...
    ttt_random_weapon_small = WEAPON_PISTOL,
...
local function PrintCount(ply)
    ...
    ply:ChatPrint("Rare Item Spawns: " .. count[WEAPON_RARE])
...
if SERVER or CLIENT then
    ...
    // key: regex pattern
    // value: class name to replace with
    local replacepatterns = {
        ["^weapon_ttt_confgrenade"] = "ttt_random_grenade",
        ["^weapon_ttt_smokegrenade"] = "ttt_random_grenade",
        ["^weapon_zm_molotov"] = "ttt_random_grenade",
        ["^weapon_zm_pistol"] = "ttt_random_weapon_small",
        ["^weapon_zm_revolver"] = "ttt_random_weapon_small",
        ["^weapon_ttt_glock"] = "ttt_random_weapon_small",
        ["^weapon_ttt"] = "ttt_random_weapon",
        ["^weapon_zm"] = "ttt_random_weapon",
        ["^item_ammo"] = "ttt_random_ammo",
        ["^item_box_buckshot_ttt"] = "ttt_random_ammo"
    }

    local function ReplaceRandom(ply, cmd, args)
        if not IsValid(ply) then return end
        ...
        for _, ent in pairs(ents.GetAll()) do
            ...
            local rpl = null
            for pattern, newClassName in pairs(replacepatterns) do
                if string.match(classname, pattern) then
                    rpl = newClassName
                    break
                end
            end
        ...
        ply:ChatPrint("Replaced " .. c .. " Specific entities with random versions.")
    end
    concommand.Add("tttweaponplacer_replacerandom", ReplaceRandom)
end
